...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 14 Des 2021 pada 05.25
...
(1, 'Wayan', 'admin123', 'Wayan', 'Yogyakarta', 1, 'wayan@gmail.com', 789456, 'Y'),
(5, 'admin', '0987654321', 'Sumartho', 'Jln.Kenari 07, Yogyakarta', 2, 'sumarthoalvari88@gmail.com', 98765, 'Y');
...
--
ALTER TABLE `tbl_detail_order`
  MODIFY `idDetailOrder` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=34;
...
--
ALTER TABLE `tbl_order`
  MODIFY `idOrder` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=26;

--
-- AUTO_INCREMENT untuk tabel `tbl_produk`
--
ALTER TABLE `tbl_produk`
  MODIFY `idProduk` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=39;
