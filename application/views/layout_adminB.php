...
<head>
    ...
    <title>Ecommerce Dashboard Pages</title>
                ...
                <form class="form-inline mr-auto">
                    ...
                    <div class="search-element">
                        ...
                        <div class="search-result">
                            ...
                            <div class="search-item">
                                <a href="#">
                                    <img class="mr-3 rounded" width="30" src="assets/admin/assets/img/products/product-3-50.png" alt="product">
                            ...
                            <div class="search-item">
                                <a href="#">
                                    <img class="mr-3 rounded" width="30" src="assets/admin/assets/img/products/product-1-50.png" alt="product">
                                    Headphone Blitz
                                </a>
                            </div>
                            <div class="search-header">
            ...
            <div class="main-sidebar">
                <aside id="sidebar-wrapper">
                    ...
                    <ul class="sidebar-menu">
                        <li><a class="nav-link" href="<?php echo site_url('Adminpanel/dashboardB'); ?>"><i class="fas fa-fire"></i> <span>Dashboard</span></a></li>

                        <li><a class="nav-link" href="<?php echo site_url('Kategori/B'); ?>"><i class="fas fa-th"></i> <span>Kategori</span></a></li>

                        <li class="nav-item dropdown">
                            <a href="#" class="nav-link has-dropdown" data-toggle="dropdown"><i class="fas fa-plane"></i> <span>Jasa Pengiriman</span></a>
                            <ul class="dropdown-menu">
                                <li><a class="nav-link" href="<?php echo site_url('Jasa_Pengiriman/kota'); ?>">Kota</a></li>
                                <li><a class="nav-link" href="<?php echo site_url('Jasa_Pengiriman/kurir'); ?>">Kurir</a></li>
                                <li><a class="nav-link" href="<?php echo site_url('Jasa_Pengiriman/ongkir'); ?>">Ongkir</a></li>
                            </ul>
                        </li>

                        <li><a class="nav-link" href="<?php echo site_url('Member'); ?>"><i class="fas fa-user"></i> <span>Member</span></a></li>

                        <li><a class="nav-link" href="<?php echo site_url('Toko'); ?>"><i class="fas fa-store"></i> <span>Toko</span></a></li>

                        <li><a class="nav-link" href="<?php echo site_url('Saran'); ?>"> <i class="fas fa-th"> </i> <span>Saran dan Kritik</span></a></li>
