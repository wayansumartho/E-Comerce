            ...
            <div class="main-sidebar">
                <aside id="sidebar-wrapper">
                    ...
                    <ul class="sidebar-menu">
                        <li><a class="nav-link" href="<?php echo site_url('Adminpanel/dashboardA'); ?>"><i class="fas fa-fire"></i> <span>Dashboard</span></a></li>

                        <li><a class="nav-link" href="<?php echo site_url('Kategori/A'); ?>"><i class="fas fa-th"></i> <span>Kategori</span></a></li>
