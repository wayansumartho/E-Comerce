                            ...
                            <div class="card gradient-bottom">
                                ...
                                <div class="card-body" id="top-5-scroll">
                                    <ul class="list-unstyled list-unstyled-border">
                                        <li class="media">
                                            <img class="mr-3 rounded" width="55" src="<?php echo base_url('assets/admin/assets/img/products/product-3-50.png'); ?>" alt="product">
                                        ...
                                        <li class="media">
                                            <img class="mr-3 rounded" width="55" src="<?php echo base_url('assets/admin/assets/img/products/product-4-50.png'); ?>" alt="product">
                                            <div class="media-body">
                                                <div class="float-right">
                                        ...
                                        <li class="media">
                                            <img class="mr-3 rounded" width="55" src="<?php echo base_url('assets/admin/assets/img/products/product-1-50.png'); ?>" alt="product">
                                            <div class="media-body">
                                                <div class="float-right">
                                        ...
                                        <li class="media">
                                            <img class="mr-3 rounded" width="55" src="<?php echo base_url('assets/admin/assets/img/products/product-5-50.png'); ?>" alt="product">
                                            <div class="media-body">
                                                <div class="float-right">
                                    ...
                                    <div class="owl-carousel owl-theme" id="products-carousel">
                                        <div>
                                            <div class="product-item pb-3">
                                                <div class="product-image">
                                                    <img alt="image" src="<?php echo base_url('assets/admin/assets/img/products/product-4-50.png'); ?>" class="img-fluid">
                                                </div>
                                        ...
                                        <div>
                                            <div class="product-item">
                                                <div class="product-image">
                                                    <img alt="image" src="<?php echo base_url('assets/admin/assets/img/products/product-3-50.png'); ?>" class="img-fluid">
                                                </div>
                                                <div class="product-details">
                                        ...
                                        <div>
                                            <div class="product-item">
                                                <div class="product-image">
                                                    <img alt="image" src="<?php echo base_url('assets/admin/assets/img/products/product-1-50.png'); ?>" class="img-fluid">
                                                </div>
                                                <div class="product-details">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-6">
                                            ...
                                            <ul class="list-unstyled list-unstyled-border list-unstyled-noborder mb-0">
                                                <li class="media">
                                                    <img class="img-fluid mt-1 img-shadow" src="<?php echo base_url('admin/node_modules/flag-icon-css/flags/4x3/id.svg'); ?>" alt="image" width="40">
